    ...
    <div>
        <div class="softdiv">
            ...
            >
                ...
                <el-table-column prop="relationName" label="餐厅名称" width="120" align="center"></el-table-column>
                ...
                <el-table-column prop="relationTime" label="营业时间" align="center"></el-table-column>
                <el-table-column prop="relationPrice" label="人均价格" align="center"></el-table-column>
            ...
            <el-dialog title="编辑" :visible.sync="editVisible" width="40%" center>
                ...
                >
                    ...
                    <el-form-item label="餐厅名称" prop="relationName" style="width: 380px;">
                    ...
                    <el-form-item label="营业时间" prop="relationTime" style="width: 380px;">
            ...
            <el-dialog title="新增" :visible.sync="addVisible" width="40%" center>
                ...
                >
                    ...
                    <el-form-item label="人均价格" prop="relationPrice" style="width: 380px;">
...
export default {
    ...
    methods: {
        getTableData() {
            let _this = this
            _this.$axios.post('/relationMs/getDataList', {}).then(res => {
                _this.tableData = res.data.data;
            });
        },
        searchButton() {
            let _this = this
            _this.$axios.post('/relationMs/getDataList', _this.searchForm).then(res => {
                _this.tableData = res.data.data;
            });
        },
        addButton() {
        ...
        saveAdd() {
            let _this = this
            _this.$axios.post('/relationMs/saveData', _this.addForm).then(res => {
                _this.$message({
                    showClose: true,
                    message: '保存成功',
                    type: 'success',
        ...
        saveEdit() {
            let _this = this
            _this.$axios.post('/relationMs/saveData', _this.editForm).then(res => {
                _this.$message({
                    showClose: true,
                    message: '保存成功',
                    type: 'success',
        ...
        delButton(params) {
            let _this = this
            _this.$axios.post('/relationMs/delData', {id: params}).then(res => {
                _this.$message({
                    showClose: true,
                    message: '删除成功',
                    type: 'success',
